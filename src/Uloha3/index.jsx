...
export const Uloha3 = () => {
	...
	const onclickJaroHandler = () => {
		console.log('Uživatel zvolil jaro')
	}

	const onclickLetoHandler = () => {
		console.log('Uživatel zvolil léto')
	}

	const onclickPodzimHandler = () => {
		console.log('Uživatel zvolil podzim')
	}

	const onclickZimaHandler = () => {
